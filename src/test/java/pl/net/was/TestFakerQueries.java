        ...
        extends AbstractTestQueryFramework
{
    ...
    public void selectRange()
    {
        ...
        testQuery = "SELECT " +
                ...
                "AND rnd_tinyint <= -128 " +
                "AND rnd_date <= DATE '-5877641-06-24' " +
                ...
                "AND rnd_timestamp  <= TIMESTAMP '-9999-01-01 00:00:00.000' " +
                "AND rnd_timestamp0 <= TIMESTAMP '-9999-01-01 00:00:00' " +
                "AND rnd_timestamp6 <= TIMESTAMP '-9999-01-01 00:00:00.000000' " +
                "AND rnd_timestamp9 <= TIMESTAMP '-9999-01-01 00:00:00.000000000' " +
                "AND rnd_timestamptz <= TIMESTAMP '-9999-01-01 00:00:00.000 +01:00' " +
                "AND rnd_timestamptz0 <= TIMESTAMP '-9999-01-01 00:00:00 +01:00' " +
                "AND rnd_timestamptz6 <= TIMESTAMP '-9999-01-01 00:00:00.000000 +01:00' " +
                "AND rnd_timestamptz9 <= TIMESTAMP '-9999-01-01 00:00:00.000000000 +01:00' " +
